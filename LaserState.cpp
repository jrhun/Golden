...
const uint8_t pinArray[40][2] = { 
  ...
  {0,1}, {2,1}, {4,1}, {8,1}, {10,1}, {0,2}, {2,2}, {4,2}, {8,2}, {10,2},
  {1,1}, {3,1}, {5,1}, {9,1}, {11,1}, {1,2}, {3,2}, {5,2}, {9,2}, {11,2},
  {6,1}, {7,1},{14,1},{12,1}, {13,1}, {6,2}, {7,2},{14,2},{12,2}, {13,2},
  {9,0}, {0,0},{15,1}, {0,0}, { 6,0}, {5,0}, {0,0},{15,2}, {0,0}, {10,0}
};
